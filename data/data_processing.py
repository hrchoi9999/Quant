# English filename: 4_data_processing_py.py
# Original path: [능률협회]머신러닝 기반 증권모델링 및 트레이딩 과정 (수강생)/15일차 딥러닝 시계열 분석 실습_ETF실습/1. 금융시계열_LSTM과Atttention/1. LSTM/4. data_processing_clear.py
# Original filename: 4. data_processing_clear.py
...
class DataProcessing:
    def __init__(self, split, feature_split):
        ...
        self.test = pd.read_csv("preprocessing/stock_data.csv", index_col=0)
