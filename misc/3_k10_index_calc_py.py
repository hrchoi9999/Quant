# English filename: 3_k10_index_calc_py.py
# Original path: [능률협회]머신러닝 기반 증권모델링 및 트레이딩 과정 (수강생)/2일차 금융 데이터 수집 및 가공/3 K10 지수 산출_수정(2024-10-05).py
# Original filename: 3 K10 지수 산출_수정(2024-10-05).py

# ---- Cell ----
!wget -nc http://youngminhome.iptime.org:5555/shared/etc_data/k10_historical_price.csv
!wget -nc http://youngminhome.iptime.org:5555/shared/etc_data/k10_info.csv
...
# ---- Cell ----
k10_historical_price = pd.read_csv("k10_historical_price.csv", index_col=0).sort_index()
...
# k10_info.to_csv("k10_info.csv")
# k10_info

k10_info = pd.read_csv("k10_info.csv", index_col=0)
...
# ---- Cell ----
k200 = pd.read_csv("k200.csv", index_col=0).sort_index()
