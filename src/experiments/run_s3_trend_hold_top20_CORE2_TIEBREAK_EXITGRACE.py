# run_s3_trend_hold_top20_CORE2_TIEBREAK_EXITGRACE_2026-02-26_001.py ver 2026-02-26_003
import sqlite3
import csv
    ...
    for i in range(1, len(rebals)):
        ...
        if need > 0:
            ...
            for _, r in cand.iterrows():
                holdings[r["ticker"]] = {"below_ma60_streak": 0, "slope_nonpos_streak": 0, "entry_date": d, "entry_price": float(r["close"]) if pd.notna(r.get("close", np.nan)) else np.nan}
