# English filename: hybrid_arima_lstm_model_py.py
# Original path: [능률협회]머신러닝 기반 증권모델링 및 트레이딩 과정 (수강생)/15일차 딥러닝 시계열 분석 실습_ETF실습/1. 금융시계열_LSTM과Atttention/1. LSTM/hybrid_ARIMA_LSTM_model(오래걸림).py
# Original filename: hybrid_ARIMA_LSTM_model(오래걸림).py

# ---- Cell ----
!wget -nc http://youngminhome.iptime.org:5555/shared/hybrid-arima-lstm-model-master/AAPL.csv

# ---- Cell ----
!wget https://launchpad.net/~mario-mariomedina/+archive/ubuntu/talib/+files/libta-lib0_0.4.0-oneiric1_amd64.deb -qO libta.deb
!wget https://launchpad.net/~mario-mariomedina/+archive/ubuntu/talib/+files/ta-lib0-dev_0.4.0-oneiric1_amd64.deb -qO ta.deb
!dpkg -i libta.deb ta.deb
!pip install ta-lib pmdarima
...
# ---- Cell ----
data = pd.read_csv('AAPL.csv', index_col=0, header=0).tail(1500).reset_index(drop=True)
data.head()
len(data)
