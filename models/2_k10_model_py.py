# English filename: 2_k10_model_py.py
# Original path: [능률협회]머신러닝 기반 증권모델링 및 트레이딩 과정 (수강생)/4일차 맞춤형 펀드 설계 및 운용/2_K10_펀드_운용_모델_clear.py
# Original filename: 2_K10_펀드_운용_모델_clear.py
...
# ---- Cell ----
!wget -nc http://youngminhome.iptime.org:5555/shared/etc_data/k10_historical_price_2.csv
!wget -nc http://youngminhome.iptime.org:5555/shared/etc_data/k200_2.csv
!wget -nc http://youngminhome.iptime.org:5555/shared/etc_data/k10_info_2.csv
...
# k10_info
# k10_info.to_csv("k10_info_2.csv")

k10_info = pd.read_csv("k10_info_2.csv", index_col=0)
k10_info.index = [f'{x:06}' for x in k10_info.index]
k10_info
...
#     start_date = '2024-01-01'   # 최신 날짜로 변경
#     end_date = '2024-03-31'
...
# k10_historical_price.to_csv("k10_historical_price_2.csv")

k10_historical_price = pd.read_csv("k10_historical_price_2.csv", index_col=0)
k10_historical_price.index = pd.to_datetime(k10_historical_price.index)
...
# ---- Cell ----
# base_date = dt.date(2024, 1, 4)
base_date = pd.Timestamp("2024-01-04")

# ---- Cell ----
k10.index = pd.to_datetime(k10.index)
...
# index_cd = 'KPI200'
# historical_prices = dict()
# kospi200 = historical_index_naver(index_cd, '2024-1-1', '2024-03-31')
# k200 = pd.DataFrame({'Index' : kospi200})
# k200.index.name = "date"
# k200.head(3)

# k200.to_csv("k200_2.csv")
k200 = pd.read_csv("k200_2.csv", index_col=0)
...
# ---- Cell ----
CU = 50000     # 설정/환매 단위
base_date = dt.date(2024, 1, 4)     # 설정 기준일
