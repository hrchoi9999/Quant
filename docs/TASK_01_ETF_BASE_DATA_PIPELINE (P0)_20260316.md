...
> 2026-04-18 운영 메모: 이 문서는 초기 P0 작업 요청 기록입니다. 현재 운영 ETF universe/price 수집은 KRX OpenAPI 기준이며, 구 pykrx/FDR ETF 가격 collector는 `D:/Quant/archive/legacy_scripts/20260418/`로 격리 보관되었습니다. 운영 절차는 `D:/Quant/docs/BACKTEST_COMMAND_20260311.md`와 `D:/Quant/docs/LEGACY_BACKFILL_SCRIPT_ARCHIVE_20260418.md`를 우선합니다.
